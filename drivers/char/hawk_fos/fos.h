...
//Auto Acquisition definitions
//Capture
#define START_CAPTURE				0x01
#define STOP_CAPTURE					0x02
//channel_mode
#define CHANNEL1_MODE				0x01
#define CHANNEL2_MODE				0x02
#define DUAL_CHANNEL_MODE			0x03
