...
struct fos_drvdata {
   ...
   dev_t devt;
   struct class *class;
   uint32_t auto_transfer_ch2;
	uint32_t auto_active;
   uint32_t auto_mig_addr;
   uint32_t auto_channel_offset_bytes;
   uint32_t auto_ch1_num_bytes;
   uint32_t auto_ch2_num_bytes;
   uint32_t auto_channel_mode;
   uint32_t auto_row_stride;
   uint32_t auto_block_count;
   int irq;
...
//FOS_Auto_Acquisition()
//Initiate Automatic transfers of data to the host memory
//
//
//
//
